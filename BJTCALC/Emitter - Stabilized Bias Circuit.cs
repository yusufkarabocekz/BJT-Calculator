...
namespace BJTCALC
{
    public partial class Emitter___Stabilized_Bias_Circuit : Form
    {
        public Emitter___Stabilized_Bias_Circuit()
        {
            InitializeComponent();
        }
        ...
        private void caltxt_Click(object sender, EventArgs e)
        {
            ...
            double ib = (vcc - vbe) / (r1*1000 + (beta + 1) * r3*1000)*1000000;
            double ic = beta * ib;
            double ie = ib*(beta+1);
        ...
        private void Emitter___Stabilized_Bias_Circuit_Load(object sender, EventArgs e)
        {
